...
def analyze(code,name,market,bdf=None):
    try:
        ...
        liq_lbl="عالية 🟢" if liq>100 else ("متوسطة 🟡" if liq>10 else "منخفضة 🔴")
...
def row_html(s,i):
    ...
    detail=(
        ...
        +note_html+
        '<div class="dq">'
        '<div class="dqi"><div class="dql">القوة النسبية</div><div class="dqv '+rs_cls+'">'+s.get("rsl","—")+'</div></div>'
        '<div class="dqi"><div class="dql">السيولة</div><div class="dqv">'+s.get("liq_lbl","—")+'</div></div>'
        '<div class="dqi"><div class="dql">ADX</div><div class="dqv">'+str(s["adx"])+'</div></div>'
        '<div class="dqi"><div class="dql">المدة</div><div class="dqv teal">'+s.get("dur","—")+'</div></div>'
        '</div>'
        ...
        '</div>'
        '<div class="rr-row"><span>R:R: <strong style="color:var(--gold)">'+str(s["rr"])+'</strong></span><span>⏱ '+s.get("dur","—")+'</span></div>'
        '</div>'
